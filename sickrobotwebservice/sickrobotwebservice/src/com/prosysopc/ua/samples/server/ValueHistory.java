...
class ValueHistory implements AggregateCalculator.HistoryDataProvider {
	...
	/**
	 * Define whether the data should be interpreted as Stepped or Sloped, i.e. the
	 * values stay as they are until the next value is recorded
	 * 
	 ...
	 * @param returnBounds
	 *            whether values at the ends of the interval should be returned as
	 *            well
	 * @param firstIndex
	 *            the index of the first entry in the history data to return (i.e.
	 *            the continuationPoint returned for the previous request)
	 * @param history
	 *            the list of values to fill in
	 * @return the first index that was not added to the history, in case there are
	 *         more than maxValues entries to return (i.e. the continuationPoint to
	 *         return)
	 */
