...
public class PlaygroundMain {
    ...
    private static org.slf4j.Logger log = LoggerFactory.getLogger(java.lang.invoke.MethodHandles.lookup().lookupClass());
    ...
    public static void main(String[] args) {
        try {
            ...
            final RTLSConnectionManager clientEndPoint = new RTLSConnectionManager(new URI(uriString));
