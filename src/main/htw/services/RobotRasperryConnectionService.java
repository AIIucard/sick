...
public class RobotRasperryConnectionService extends Service<Void> {
	...
	public RobotRasperryConnectionService(SickDatabase database, CountDownLatch countDownLatch) {
