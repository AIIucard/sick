...
public class MyBigNodeManager extends NodeManager {
	...
	public class MyBigIoManager extends IoManager {
		 ...
		 * (non-Javadoc)
		 *
		 * @see com.prosysopc.ua.server.IoManager#readNonValue(com.prosysopc.ua. server
		 ...
		 * (non-Javadoc)
		 *
		 * @see com.prosysopc.ua.server.IoManager#readValue(com.prosysopc.ua.server
		 * .ServiceContext, org.opcfoundation.ua.builtintypes.NodeId,
		 * com.prosysopc.ua.nodes.UaVariable, org.opcfoundation.ua.utils.NumericRange,
	...
	public class MyReference extends UaReference {
		 ...
		 * (non-Javadoc)
		 *
		 * @see com.prosysopc.ua.nodes.UaReference#getIsInverse(com.prosysopc.ua.
		 * nodes.UaNode)
		 */
		@Override
	 ...
	 * @return newNode, if it was added or the node with the same NodeId if such was
